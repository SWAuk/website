...
if ( $saveOrder ) {
	...
	JHtml::_( 'sortablelist.sortable', 'ticketList', 'adminForm', strtolower( $listDirn ), $saveOrderingUrl );
}
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=tickets' ); ?>" method="post" name="adminForm" id="adminForm">
