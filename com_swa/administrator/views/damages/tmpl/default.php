...
if ( $saveOrder ) {
	$saveOrderingUrl = 'index.php?option=com_swa&task=damages.saveOrderAjax&tmpl=component';
	JHtml::_( 'sortablelist.sortable', 'damageList', 'adminForm', strtolower( $listDirn ), $saveOrderingUrl );
}
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=damages' ); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="damageList">
				<thead>
				<tr>
					...
					<th class='left'>
						<?php echo JHtml::_( 'grid.sort', 'COM_SWA_DAMAGES_UNIVERSITY', 'a.university', $listDirn, $listOrder ); ?>
					</th>
					<th class='left'>
						<?php echo JHtml::_( 'grid.sort', 'COM_SWA_DAMAGES_EVENT', 'a.event', $listDirn, $listOrder ); ?>
					</th>
					<th class='left'>
						<?php echo JHtml::_( 'grid.sort', 'COM_SWA_DAMAGES_DATE', 'a.date', $listDirn, $listOrder ); ?>
					</th>
					<th class='left'>
						<?php echo JHtml::_( 'grid.sort', 'COM_SWA_DAMAGES_COST', 'a.cost', $listDirn, $listOrder ); ?>
					</th>
				...
				<?php foreach ( $this->items as $i => $item ) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if ( isset( $this->items[0]->state ) ): ?>
							<td class="center">
								<?php echo JHtml::_( 'jgrid.published', $item->state, $i, 'damages.', $canChange, 'cb' ); ?>
							</td>
						<?php endif; ?>
