...
<?php endif;?>
		...
		<table class="table table-striped" id="grantList">
			<thead>
				<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_SWA_GRANTS_AMMOUNT', 'a.ammount', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<td>
					...
					<?php echo $item->finances_date; ?>
				</td>
				<td>

					<?php echo $item->auth_date; ?>
				</td>
				<td>
