...
if ( $saveOrder ) {
	...
	JHtml::_( 'sortablelist.sortable', 'depositList', 'adminForm', strtolower( $listDirn ), $saveOrderingUrl );
}
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=deposits' ); ?>" method="post" name="adminForm" id="adminForm">
