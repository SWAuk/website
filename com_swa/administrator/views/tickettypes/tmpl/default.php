...
if ( $saveOrder ) {
	$saveOrderingUrl = 'index.php?option=com_swa&task=tickettypes.saveOrderAjax&tmpl=component';
	JHtml::_( 'sortablelist.sortable', 'tickettypeList', 'adminForm', strtolower( $listDirn ), $saveOrderingUrl );
}
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=tickettypes' ); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="tickettypeList">
				...
				<tr>
					...
					<th class='left'>
						<?php echo JHtml::_( 'grid.sort', 'COM_SWA_TICKETTYPES_NAME', 'a.name', $listDirn, $listOrder ); ?>
					</th>
				...
				<?php foreach ( $this->items as $i => $item ) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if ( isset( $this->items[0]->state ) ): ?>
							<td class="center">
								<?php echo JHtml::_( 'jgrid.published', $item->state, $i, 'tickettypes.', $canChange, 'cb' ); ?>
							</td>
						<?php endif; ?>

						<td>
							<?php if ( isset( $item->checked_out ) && $item->checked_out ) : ?>
								<?php echo JHtml::_( 'jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'tickettypes.', $canCheckin ); ?>
							<?php endif; ?>
							<?php if ( $canEdit ) : ?>
								<a href="<?php echo JRoute::_( 'index.php?option=com_swa&task=tickettype.edit&id=' . (int)$item->id ); ?>">
