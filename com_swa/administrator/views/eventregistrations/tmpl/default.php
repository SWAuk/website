...
if ( $saveOrder ) {
	...
	JHtml::_( 'sortablelist.sortable', 'eventregistrationList', 'adminForm', strtolower( $listDirn ), $saveOrderingUrl );
}
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=eventregistrations' ); ?>" method="post" name="adminForm" id="adminForm">
...
<table class="table table-striped" id="eventregistrationList">
	<thead>
	<tr>
