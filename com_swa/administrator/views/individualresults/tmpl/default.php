...
if ( $saveOrder ) {
	$saveOrderingUrl = 'index.php?option=com_swa&task=individualresults.saveOrderAjax&tmpl=component';
	JHtml::_( 'sortablelist.sortable', 'individualresultList', 'adminForm', strtolower( $listDirn ), $saveOrderingUrl );
}
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=individualresults' ); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="individualresultList">
				<thead>
				<tr>
				...
				<?php foreach ( $this->items as $i => $item ) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if ( isset( $this->items[0]->state ) ): ?>
							<td class="center">
								<?php echo JHtml::_( 'jgrid.published', $item->state, $i, 'individualresults.', $canChange, 'cb' ); ?>
							</td>
						<?php endif; ?>
