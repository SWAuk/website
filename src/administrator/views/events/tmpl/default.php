...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_swa&task=events.saveOrderAjax&tmpl=component';
	JHtml::_(
...
<form action="<?php echo JRoute::_('index.php?option=com_swa&view=events'); ?>" method="post"
						...
						<td>
							<?php if ($canEdit)
								...
								<a href="<?php echo JRoute::_(
									'index.php?option=com_swa&task=event.edit&id=' . (int) $item->id
								); ?>">
