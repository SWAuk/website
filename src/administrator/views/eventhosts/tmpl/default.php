...
if ( $saveOrder ) {
	$saveOrderingUrl = 'index.php?option=com_swa&task=eventhosts.saveOrderAjax&tmpl=component';
	JHtml::_(
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=eventhosts' ); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<div id="adminview-description">
				<p>Here you can see and add universities to events as hosts. One event can have
					multiple university hosts (or none).</p>

				<p>Being added here allows members from these universities to purchase tickets
					marked as 'Needs Host'.</p>
			</div>
			...
			<table class="table table-striped" id="evenhostList">
				<thead>
				<tr>
