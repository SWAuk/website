...
if ( $saveOrder ) {
	...
	JHtml::_( 'sortablelist.sortable', 'eventhostList', 'adminForm', strtolower( $listDirn ), $saveOrderingUrl );
}
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=eventhosts' ); ?>" method="post" name="adminForm" id="adminForm">
