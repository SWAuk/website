...
<form action="<?php echo JRoute::_('index.php?option=com_swa&view=competitiontypes'); ?>"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<div id="adminview-description">
				<p>Here you can see and add different types of competition. These competition types
					can then be used in competitions at events!</p>
			</div>
						...
						<td>
							<?php if ($canEdit)
								...
								<a href="<?php echo JRoute::_(
									'index.php?option=com_swa&task=competitiontype.edit&id=' .
									(int) $item->id
								); ?>">
