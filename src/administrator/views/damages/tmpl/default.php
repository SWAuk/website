...
$saveOrder = $listOrder == 'damages.ordering';
if ( $saveOrder ) {
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=damages' ); ?>" method="post"
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="damageList">
				...
				<?php foreach ( $this->items as $i => $item ) :
					$ordering = ( $listOrder == 'damages.ordering' );
