...
<div>
	<div>
		<form action="<?php echo JRoute::_('index.php?option=com_swa&view=university_agreements'); ?>" method="post" name="adminForm" id="adminForm">
			...
			?>
				...
				?>
					...
					<div id="adminview-description">
						<div class="tab">
							<button class="tablinks" onclick="openTab(event, 'view_current_agreements')">View Agreement Statuses</button>
							<button class="tablinks" onclick="openTab(event, 'edit_agreement')">Edit Agreement</button>
						</div>
					...
					<div>
						<div class="tabcontent" id="edit_agreement">
							<h2> second tabs </h2>
						</div>
					</div>

					<div id="view_current_agreements" class="tabcontent active">
						...
						<div id="filter-bar" class="btn-toolbar">
							<div class="filter-search btn-group pull-left">
								...
								<input type="search" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('JSEARCH_FILTER'); ?>" />
							</div>
							<div class="btn-group pull-left">
								<button class="btn hasTooltip" type="submit" title="<?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?>">
									<i class="icon-search"></i></button>
								<button class="btn hasTooltip" type="button" title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>" onclick="getElementById('filter_search').value='';this.form.submit();">
