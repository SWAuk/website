...
<form action="<?php echo JRoute::_('index.php?option=com_swa&view=universitymembers'); ?>"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<div id="adminview-description">
				...
				<p>Members marked as 'graduated' can purchase tickets marked as 'Needs XSWA'.</p>
			</div>
			...
			<table class="table table-striped" id="universitymemberList">
				...
				<tr>
					...
					<th class='left'>
						<?php
						echo JHtml::_('grid.sort', 'Committee Position', 'committee', $listDirn, $listOrder);
						?>
					</th>
					<th class='left'>
						<?php echo JHtml::_('grid.sort', 'Graduated', 'graduated', $listDirn, $listOrder); ?>
					</th>
				</tr>
				</thead>
				<tfoot>
				...
				<?php foreach ($this->items as $i => $item)
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td>
							...
							<small style="color: grey;"><?php echo $item->email ?></small>
						</td>
						<td>
