...
$saveOrder = $listOrder == 'committee.ordering';
if ( $saveOrder ) {
	$saveOrderingUrl =
		'index.php?option=com_swa&task=committeemembers.saveOrderAjax&tmpl=component';
	JHtml::_(
...
<form action="<?php echo JRoute::_( 'index.php?option=com_swa&view=committeemembers' ); ?>"
		...
		<div id="j-main-container">
			...
			<div id="adminview-description">
				...
				<p>Everyone in this list will appear in the 'committee' frontend view and also be
					given access anything with the 'Org committie' view level.</p>
			...
			<table class="table table-striped" id="committeememberList">
				...
				<?php foreach ( $this->items as $i => $item ) :
					$ordering = ( $listOrder == 'committee.ordering' );
