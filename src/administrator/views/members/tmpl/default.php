	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<div id="adminview-description">
				<p>Here you can see and add members of the Org. This list is different to the Joomla
					Users list.</p>

				<p>People must register on the site (Joomla) before they can become a member of the
					Org.</p>
			</div>
