...
DROP TABLE IF EXISTS `#__swa_qualification`;
DROP TABLE IF EXISTS `#__swa_committee`;
DROP TABLE IF EXISTS `#__swa_instructor`;
DROP TABLE IF EXISTS `#__swa_university`;
DROP TABLE IF EXISTS `#__swa_university_member`;
...
DROP TABLE IF EXISTS `#__swa_event_registration`;
