 ...
 * View to edit
 */
class Swa_universitiesViewUniversity extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        $canDo = Swa_universitiesHelper::getActions();

        JToolBarHelper::title(JText::_('COM_SWA_UNIVERSITIES_TITLE_UNIVERSITY'), 'university.png');
