...
CREATE TABLE `swana_swa_membership` (
  ...
  -- the uni committee has approved the member into their club for that year
  `approved` TINYINT(1) NOT NULL DEFAULT 0,
  -- TODO: Change to uni_committee so as not to confuse with SWA Committee?
  `committee` varchar(20) DEFAULT NULL,
  KEY `fk_membership_member_idx` (`member_id`),
  KEY `fk_membership_season_idx` (`season_id`),
  CONSTRAINT `unique_member_id_season_id` UNIQUE (`member_id`, `season_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `swana_swa_membership`
  (`id`, `member_id`, `season_id`, `paid`, `level`,        `uni_id`, `approved`, `committee`) VALUES
  (1,    4,           20,          0,      'Beginner',     1,        1,          0),
  (2,    5,           20,          1,      'Intermediate', 1,        1,          0),
  (3,    6,           20,          1,      'Advanced',     1,        1,          1),
  (4,    1,           20,          1,      'Advanced',     1,        1,          'President');
...
INSERT INTO `swana_swa_ticket`
  (`id`, `member_id`, `event_ticket_id`, `paid`, `details`) VALUES
  (1,    6,           2,                 0.00,   '{\"addons\":[]}'),
  (2,    5,           1,                 0.00,   '{\"addons\":[]}'),
